...
import WelfareDashboardPage from 'src/pages/app/WelfareDashboardPage.vue';
import { LocalStorage } from 'quasar';
import { AssignedUserResourceData } from 'src/models/auth/AssignedUserResource.model';
...
const userResource = computed(() => {
  var resource = result.value as AssignedUserResourceData;
  console.log('resource____', resource);
  return resource;
});
