<template>
  <q-page>
    <div class="wrapper" v-if="isValid == 'valid'">
      <section class="login-content">
        <div class="row m-0 align-items-center bg-white vh-100">
          <div class="col-md-7 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            <q-img src="../../assets/images/cc/cc-auth.svg" class="img-fluid gradient-main animated-scaleY" alt="images"
              style="height: 100vh;" fit="contain" />
          </div>
                  ...
                  <div class="card-body">
                    <div class="navbar-brand d-flex align-items-center mb-3">
                      <div class="logo-main">
                        ...
                        <div class="logo-mini">
                          <q-img src="../../assets/images/cc/logo.png" />
                        </div>
                      </div>
                      <q-img src="../../assets/images/cc/logo.png" fit="scale-down" height="8rem" width="14rem" />
                    </div>
                    <h2 class="mb-2 text-center">Register</h2>
                    <p class="text-center">Register to stay connected.</p>
                    <q-form @submit="onProcessRegister">
                      <q-card color="primary" animated flat class="card-shadow">
                        <q-card-section>
                          <div class="row q-col-gutter-x-lg">
                            ...
                            <div class="col-12">
                              <q-input v-model="userPayload.emailAddress" label="Email Address" type="email" lazy-rules
                                :rules="[
      ...
      (val) => val.length == 10 || 'Must be 10 digits'
                      ...
                      <div class="row q-mt-xl justify-evenly q-gutter-x-md">
                        <div class="col-12 q-mt-xl">
                          <q-btn icon="app_registration" color="text-white" class=" primary-color full-width"
                            label="Register" type="submit" :loading="loading" />
    ...
    <div v-if="isValid == 'invalid'">
      <q-card class="my-card" style="height: 100vh;" fit="contain">
        <!-- <q-img src="../../assets/images/cc/logout.svg" style="width: 40em;" /> -->
        <q-img src="../../assets/images/cc/logout.svg" class="img-fluid gradient-main animated-scaleY" alt="images"
          style="height: 88vh;" fit="contain" />
        <q-card-section class="q-pt-none q-mt-xl q-mb-xl">
          <div class="text-h4 text-bold row justify-center q-mt-lg">
            {{ invalidMessage }}
          </div>
    ...
    <q-inner-loading :showing="loaderVisible" size="50px" label="Verifying invitation link"
      label-class="text-primary-color text-bold" label-style="font-size: 2em">
    </q-inner-loading>
  </q-page>
</template>
...
const verifyInvitationCode = ref({
  invitationCode: route.params['invitation_code'],
});

const loaderVisible = ref(true);
const isValid = ref('none');
...
const userPayload = ref(
  {
    ...
    emailAddress: '',
    contact: '',
    createdBy: uamStore.registerInvitationCode.createdBy,
    institutionId: uamStore.registerInvitationCode.institutionId,
  });
...
const onVerifyInvitationCode = async () => {
  loading.value = true;
  const result = await uamStore.verifyInvitationCode(verifyInvitationCode.value);
  loading.value = false;
  if (result.status == AAStatusConstants.SUCCESS) {
    ...
    loaderVisible.value = false;
    invalidMessage.value = result.message;
    // $q.notify({
    //   color: 'red-8',
    //   textColor: 'white',
    //   icon: 'close',
