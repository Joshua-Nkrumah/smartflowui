        ...
        <div class="row q-col-gutter-x-md">
          <div class="row items-center">
            <q-item-label class="text-h6 text-weight-bold"><q-icon name="app_registration" size="1.5rem"
                class="q-mr-md" />Subscription
            </q-item-label>
          </div>
        </div>
      </template>
      <template #sub-title>
        <div class="text-h7 text_weight_light">Manage your subscription</div>
      </template>
    </MainBottomHeader>
            ...
            <q-card-section>
              <q-item class="q-mt-md">
                <q-item-section avatar>
                  <my-avatar color="green-8" text-color="white" :shape="ShapeConstants.ROUNDED"
                    label="Institution Subscription" size="4rem" font-size="1.5rem" />
                </q-item-section>
                <q-item-section>
                  <q-item-label> <q-badge outline color="green-8" label="Cleverchap Basic" class="text-bold text-h5" />
                  </q-item-label>
                  <q-item-label class="text-h6 text-subtitle2">View apps, features and roles in your
                    subscription</q-item-label>
                </q-item-section>
              </q-item>
            </q-card-section>
            <q-separator />
